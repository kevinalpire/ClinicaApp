        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <a class="p-2 bg-blue-900 text-white rounded-lg" href="{{route('cargos.create')}}">Añadir cargo</a>
                    </div>
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-no-wrap">{{ $cargo->descripcion }}</td>
                                <td class="px-6 py-4 whitespace-no-wrap">{{ $cargo->clinica->nombre }}</td>
                                {{-- <td class="px-6 py-4 whitespace-no-wrap">{{ $cargo->clinica->nombre }}</td> --}}
                                <td>
